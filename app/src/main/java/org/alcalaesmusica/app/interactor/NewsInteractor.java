...
import org.alcalaesmusica.app.model.NewsState;
...
//        realm.commitTransaction();
    ...
    public List<News> getNewsFromDBAvoidPrevious() {

        return Realm.getDefaultInstance().where(News.class).greaterThanOrEqualTo(News.ID, 10).findAllSorted(News.START_DATE_POPUP_TIME, Sort.DESCENDING);
    }
